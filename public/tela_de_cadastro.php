    ...
    <div class="container vh-100 d-flex align-items-center">
        <div class="p-3" style="max-width: 400px; width: 100%;">
            ...
            <div class="titulo">
                ...
                <h1 class="text-nowrap">Cadastro de Usuários</h1>
            ...
            <div class="botao">
                <div class="d-grid gap-2">
                    <button class="btn btn-primary" type="button" onclick="cadastrarUsuario()">
                        Cadastrar!
                    </button>
                </div>
                <a href="tela_inicial.html" class="signup-link">Voltar para a tela de início.</a>
            </div>
        </div>

        <img src="../assets/img/trem-png novo.webp" alt="" style="margin-left:auto">

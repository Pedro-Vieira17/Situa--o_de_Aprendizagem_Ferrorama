...
<body>
    ...
    <div class="layout">
        ...
        <aside class="menu-lateral">
            ...
            <a href="monitoramento_tempo_real.php" class="item">
                <img src="../assets/icons/relatorio_branco.svg" alt=""> Monitoramento
            </a>
        ...
        <form class="form-sensor" method="POST" action="salvar_trem.php">
            ...
            <div class="botoes-formulario">
                ...
                <button type="button" class="botao_cancelar"
                    onclick="window.location.href='gerenciar_trens.php'">Cancelar</button>
